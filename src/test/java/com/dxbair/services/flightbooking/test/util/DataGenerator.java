...
public class DataGenerator {
	...
	public static void main(String[] args) throws IOException {
		...
		generateDataToFile("names-input.txt", "names-output.csv",
				line -> new StringBuilder().append(line[0]).append(",")
						.append(line[1]).append(",")
						.append(line[0].toLowerCase()).append(".").append(line[1].toLowerCase())
	...
	public static void generateDataToFile(String inputFile, String outputFile,
			Function<String[], StringBuilder> dataBuilder) throws IOException {

		Stream<String> stream = Files
				.lines(Paths.get(URI.create(DataGenerator.class.getResource(inputFile).toString())));
		...
		stream.forEach(line -> {
			...
			try {
				Files.write(outputPath, outputLine.toString().getBytes(), StandardOpenOption.CREATE,
